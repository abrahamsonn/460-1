...
void process_job(job* job_in, int p_usage);
...
int main(int argc, char* argv[])
{
    ...
    int i;
    int job_counter = 0;
    int processor0_busy = 0, processor1_busy = 0, processor2_busy = 0, processor3_busy = 0;
    ...
    for (i = 0; ; i++) {
        ...
        else if (job_counter % 4 == 1) {

            if (processor1_busy != 0) {
                continue;
            }
